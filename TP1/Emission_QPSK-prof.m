...
fp = 2.4e9;    % Fréquence porteuse de l'Adalm Pluto (à modifier selon votre canal)
...
% phaseFreqOffset = comm.PhaseFrequencyOffset('FrequencyOffset',100,'PhaseOffset',0,'SampleRate',fech);
